...
import com.example.Computer_shop_management_system.service.ProductService;
        ...
        try {
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, false)) {
                    ...
                    return AppUtils.getResponseEntity("Product Added Successfully. ", HttpStatus.OK);
                }
            ...
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, true)) {
                    ...
                    if (optional.isPresent()) {
                        ...
                        return AppUtils.getResponseEntity("Product updated successfully.", HttpStatus.OK);
                    } else {
                        return AppUtils.getResponseEntity("Product id doesn't exists. ", HttpStatus.OK);
                    }
                }
                return AppUtils.getResponseEntity(AppConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
            } else {
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (optional.isPresent()) {
                    ...
                    return AppUtils.getResponseEntity("Product deleted successfully.", HttpStatus.OK);
                }
                return AppUtils.getResponseEntity("Product id doesn't exists.", HttpStatus.OK);
            } else {
                return AppUtils.getResponseEntity(AppConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (optional.isPresent()) {
                    ...
                    return AppUtils.getResponseEntity("product status updated successfully. ", HttpStatus.OK);
                } else {
                    return AppUtils.getResponseEntity("Product id does not exist. ", HttpStatus.OK);
                }
            } else {
                return AppUtils.getResponseEntity(AppConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
            }
