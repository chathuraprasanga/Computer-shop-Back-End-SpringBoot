...
//            bill.setProductDetails((String) requestMap.get("productDetails"));    //comment due to the sql not working.
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (AppUtils.isFileExist(filePath)){
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try{
            ...
            if (optional.isPresent()){
                ...
                return AppUtils.getResponseEntity("Bill deleted successfully. ", HttpStatus.OK);
            }
            return AppUtils.getResponseEntity("Bill id doesn't exists. ", HttpStatus.OK);
        }catch (Exception ex){
            ex.printStackTrace();
        }
        return AppUtils.getResponseEntity(AppConstants.SOMETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
